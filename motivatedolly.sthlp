...
age-appropriate books to children each month so that "all children [can] grow up in a home full of books." 
In case we didn't love Dolly enough, here's a {browse  "https://imaginationlibrary.com/news-resources/research/":link} to all the research evaluating the impact of her charity.
...
{pstd}
Some quotes do not have citations because the original context of the quote is difficult to find. I think it just makes her more of an enigma! If any quotes are incorrectly attributed, please contact the author of this package.
